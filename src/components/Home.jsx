...
const Home = () => {
  ...
  return (
    <div className="flex flex-col justify-start items-center w-full gap-12 px-40 py-24 md:px-20 lg:px-40 xl:px-80 h-screen bg-[#EBF6E9]">
      <div className="flex flex-col md:flex-row justify-between items-center w-full gap-2">
        <div className="flex flex-col justify-start items-start gap-2">
          <p className="text-2xl md:text-3xl lg:text-4xl font-normal">Hello</p>
          <DataComponent />
        </div>
        <Button
